    ...
    <div className="max-w-screen-xl mx-auto">
      <div className="grid grid-cols-12">
        <div className="col-span-12 md:col-span-7 p-2">
          ...
          <Card className="px-6 md:px-8 py-4">
            ...
            <p className="text-justify text-gray-600">
              K.C. College of Engineering & Management Studies & Research (KCCEMSR), located in Thane, Mumbai, is a premier engineering institute established in 2001 under the Excelsior Education Society. The college is NAAC Accredited with A Grade and affiliated to the University of Mumbai. It focuses on academic excellence, innovation, and industry-oriented learning.
            </p>
        ...
        <div className="col-span-12 md:col-span-5 my-4 p-2">
          <h2 className="font-bold text-xl mb-2">Notices</h2>
